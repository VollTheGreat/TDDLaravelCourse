...
class PurchaseTicketsTest extends TestCase
{
    ...
    /** @test* */
    function ticket_quantity_at_least_1_to_purchase_tickets()
    {
        // Arrange
        $concert = factory(Concert::class)->states('published')->create();
        //Act
    ...
    function order_is_not_created_if_payment_fails()
    {
        ...
        $this->orderTickets(
            ...
            'email' => 'john@example.com',
            'ticket_quantity' => 3,
            'payment_token' => 'invalidePaymentToken',
        ]);
        //Assert
    ...
    /** @test* */
    function cannot_buy_more_tickets_than_remain()
    {
    ...
    /** @test* */
    function cannot_purchase_tickets_another_customer_is_already_trying_tu_purchase()
    {
        $this->disableExceptionHandling();
        // Arrange
